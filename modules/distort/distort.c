...
//extern fract32 _ld_div32(fract32 numerator, fract32 denominator);
...
fract32 fract32exp(fract32 power)
{
  return float_to_fr32(exp(fr32_to_float(power)));
}

fract32 fract32div(fract32 num, fract32 denom)
{
  return float_to_fr32(fr32_to_float(num) / fr32_to_float(denom));
}
